...
def create_budget_endpoint(payload: BudgetCreate, current_user: 
...
def list_budgets_endpoint(current_user: User = Depends(get_current_user), 
...
def edit_budget_endpoint(budget_id: int, payload: BudgetUpdate, 
                         db: Session = Depends(get_db)):
